...
const CardsContainer = () => {
    ...
    // const mxPlayerMovies = movies.mxPlayerMovies;

    // const moviesCategories = [];
    
  //  mxPlayerMovies && mxPlayerMovies.map((section) => {
  //   moviesCategories.push({name: section.name, items: section.items}); 
  //   }); 


    // if(!mxPlayerMovies.length) return; 
...
{/* {mxPlayerMovies.map((movie,i) => <MoviesCards key={i} name={movie.name} movies={movie.items} />)} */}
