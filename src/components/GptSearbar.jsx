  ...
  return (
    <div className='bg-black text-white p-4 w-1/2' >
        <form onSubmit={(e) => e.preventDefault()} className='flex gap-3 w-full'>
            <input type="text" name="search" ref={searchQuery} placeholder={languageText?.gptSearchPageText[lang]?.placeHolder} className='w-4/5 px-4 py-2 text-black ' autoComplete='off'/>
